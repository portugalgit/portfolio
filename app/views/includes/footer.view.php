  ...
  <footer id="footer" class="footer">
    ...
    <div class="footer-content">
      <div class="container">
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <h3 class="footer-heading">Sobre ACELNET</h3>
            <p>ACELNET é uma empresa angola, com foco na formação, consultoria e prestação de serviços, constituida em 2018. Tem como objectivo prestar serviços voltado na área da tecnologia. </p>
      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <div class="copyright">
              © Copyright <strong><span>ACELNET</span></strong>. All Rights Reserved
            </div>
            ...
            <div class="credits">
              ...
              Designed by <a href="https://bootstrapmade.com/">Afonso Celso Caluege</a>
            </div>
